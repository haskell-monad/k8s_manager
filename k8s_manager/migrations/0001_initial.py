# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2019-01-10 14:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('node_type', models.CharField(choices=[(1, b'\xe5\x86\x85\xe9\x83\xa8\xe6\x9c\x8d\xe5\x8a\xa1\xe5\x99\xa8'), (2, b'\xe5\x86\x85\xe9\x83\xa8\xe8\x99\x9a\xe6\x8b\x9f\xe6\x9c\xba'), (3, b'\xe9\x98\xbf\xe9\x87\x8c\xe4\xba\x91'), (4, b'\xe8\x85\xbe\xe8\xae\xaf\xe4\xba\x91'), (5, b'\xe4\xba\xa4\xe6\x8d\xa2\xe6\x9c\xba'), (6, b'\xe9\x98\xb2\xe7\x81\xab\xe5\xa2\x99')], max_length=40)),
                ...
                ('ssh_enabled', models.CharField(choices=[(b'yes', b'yes'), (b'no', b'no')], max_length=5)),
                ('create_date', models.DateField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kube_version', models.IntegerField(choices=[(b'v1.8', b'v1.8'), (b'v1.9', b'v1.9'), (b'v1.10', b'v1.10'), (b'v1.11', b'v1.11'), (b'v1.12', b'v1.12')])),
                ('deploy_mode', models.IntegerField(choices=[(b'allinone', b'allinone'), (b'single-master', b'single-master'), (b'multi-master', b'multi-master')])),
                ...
                ('harbor_install', models.CharField(choices=[(b'yes', b'yes'), (b'no', b'no')], max_length=5)),
                ...
                ('deploy', models.CharField(choices=[(b'yes', b'yes'), (b'no', b'no')], max_length=5)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('version_env', models.IntegerField()),
                ('product_contact', models.CharField(max_length=50)),
                ('dev_manager', models.CharField(max_length=20)),
                ('dev_contact', models.CharField(max_length=50)),
                ('qa_manager', models.CharField(max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deploy_type', models.IntegerField()),
                ('create_date', models.DateField(auto_now_add=True)),
                ('update_date', models.DateField(auto_now=True)),
                ('create_user', models.CharField(max_length=20)),
                ('update_user', models.CharField(max_length=20)),
